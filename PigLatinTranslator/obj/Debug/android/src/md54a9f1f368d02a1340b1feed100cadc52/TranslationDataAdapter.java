...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PigLatinTranslator.TranslationDataAdapter, PigLatinTranslator, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", TranslationDataAdapter.class, __md_methods);
	}


	public TranslationDataAdapter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == TranslationDataAdapter.class)
			mono.android.TypeManager.Activate ("PigLatinTranslator.TranslationDataAdapter, PigLatinTranslator, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
